...
void createQuestion(stQuestion& question, short questionNumber, enLevel level, enOpType opType, short numberOfQuestions)
{
...
void answerQuestion(stQuestion& question, short numberOfQuestions)
{
...
void createAndAnswerQuestions(stQuizzInfo& quizInfo)
{
	...
	{
		createQuestion(quizInfo.Questions[i - 1], i, quizInfo.Level, quizInfo.OpType, quizInfo.NumberOfQuestions);
		answerQuestion(quizInfo.Questions[i - 1], quizInfo.NumberOfQuestions);
